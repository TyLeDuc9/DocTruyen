...
export const CommentReply: React.FC<CommentReplyProps> = ({
  ...
  const {sendReply, content, setContent}=useSendReply(commentId, onClose)
  return (
    <div className="mt-2 relative">
      <form action="" onSubmit={sendReply}>
        ...
        <div className="flex justify-end mt-2">
          <button type="submit" className="px-3 cursor-pointer py-1.5 text-sm text-white bg-main rounded-lg">
            Gửi
          </button>
        </div>
      </form>
