...
import type { GetUserParams } from "../../types/userType";

type Props = {
  filters: GetUserParams;
  updateFilter: (data: Partial<GetUserParams>) => void;
  handleReset: () => void;
  handleSearch: () => void;
  searchText: string;
        ...
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">
              Search and filter users faster
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-3">
        ...
        <div className="flex flex-col gap-1">
          ...
          <select
            ...
            onChange={(e) =>
              updateFilter({
                role: e.target.value as "user" | "admin" | "author",
              })
            }
          >
