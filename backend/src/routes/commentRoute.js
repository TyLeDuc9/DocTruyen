...
router.delete("/parent/:id",verifyToken, verifyRole("admin"), commentController.deleteParentComment);
router.delete("/reply/:commentId/:replyId",verifyToken, commentController.deleteReplyAdmin);
