...
router.post("/create",verifyToken, verifyRole('admin'), uploadStory.single("thumbnail"), storyController.createStory);
...
router.put("/update/:slug",uploadStory.single("thumbnail"),storyController.updateStory);
router.patch("/soft/:id", verifyToken, verifyRole("admin"), storyController.softDeleteStory);
router.patch("/restore/:id", verifyToken, verifyRole("admin"), storyController.restoreStory);
